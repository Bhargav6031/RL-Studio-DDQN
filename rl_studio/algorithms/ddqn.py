...
class DeepQ:
    ...
    def calculateTarget(self, qValuesNewState,newState, reward,minibatch_size, isFinal):
        """
        ...
        if isFinal:
            ...
            return reward + self.discountFactor * qValuesNewState[np.arange(minibatch_size),next_action]
